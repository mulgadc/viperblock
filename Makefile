...
security-check:
	...
	@echo "  govulncheck ok"
	$(_Q)set -o pipefail && go tool gosec -exclude=G104,G204,G304,G402,G602,G117,G122,G703,G705,G706 -exclude-dir nbd -exclude-generated ./... $(_SECQ) tests/gosec-report.txt $(if $(QUIET),|| { cat tests/gosec-report.txt; exit 1; })
	@echo "  gosec ok"
